...
//			int v=(i * 3) % n + 1;
	...
	public static void main1(int n) {
		...
		long[] ans1a=main1Array(N, C, query, seed);
		long[] ans1f=main1Fenwick(N, C, query, seed);
	...
	public static long[] main1Array(final int N, final int C, int[][] query, long seed) {
	...
	public static long[] main1Fenwick(final int N, final int C, int[][] query, long seed) {
		Random r=new Random(seed);
		long st1=System.currentTimeMillis();
		int[] ary=new int[N];
		for (int i=0; i<N; i++) {
...
end of main1Fenwick 25 1
end of main1Array 104 2070
end of main1Fenwick 158 1
end of main1Array 1007 18719
end of main1Fenwick 1365 0
*/
