...
//		System.out.println(Arrays.toString(apt));
		...
		while (true) {
			...
			Answer a1=resolve(an, r1);
			int score2=a1.score;
			if (an.score<=score2) {
				if (an.score<score2) {
                    System.err.println("iteration: "+iteration+", score: "+score2+" r1="+r1);
				}
				an=a1;
			}
		}
	...
	static Answer resolve(Answer a0, int r1) {
		score=1;
		ans=new int[n];
		flag=new boolean[n];
