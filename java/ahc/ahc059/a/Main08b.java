...
//					if (flag[y2][x2]) continue;
	...
	void solve() {
		...
		Answer ans3=solve03();
		Answer ans=ans7;
//		if (ans.score()<ans6.score()) ans=ans6;
//		if (ans.score()<ans5.score()) ans=ans5;
//		if (ans.score()<ans4.score()) ans=ans4;
//		if (ans.score()<ans3.score()) ans=ans3;
		ans.print();
	}
	Answer solve07() {
			...
			}
			{
				...
				if (ao!=null) {
					...
					if (aoo!=null) {
						...
						if (aooo!=null) {
							System.err.println("DEBUG1:"+py(aooo[0])+","+px(aooo[0])+","+aai[py(aooo[0])][px(aooo[0])]);
							System.err.println("DEBUG2:"+py(aoo[0])+","+px(aoo[0])+","+aai[py(aoo[0])][px(aoo[0])]);
							System.err.println("DEBUG3:"+py(ao[0])+","+px(ao[0])+","+aai[py(ao[0])][px(ao[0])]);
							System.err.println("DEBUG4:"+py(ap[0])+","+px(ap[0])+","+aai[py(ap[0])][px(ap[0])]);
