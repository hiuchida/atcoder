...
//		System.out.println(Arrays.toString(ar));
		...
		for (int i=0; i<n/2; i++) {
			...
			flag[minist]=true;
			p0=ar[minist].ed;
			int minied=minved(pn);
			ans.ai[n-1-i]=minied;
			flag[minied]=true;
			pn=ar[minied].st;
		}
//		System.out.println(p0+" "+pn);
//		System.out.println(ar[ans.ai[23]]+" "+ar[ans.ai[26]]);
//		int ministed=minvsted(p0, pn);
//		System.out.println(ministed/N+" "+ministed%N);
//		ans.ai[24]=ministed/N;
//		ans.ai[25]=ministed%N;
		int idx=0;
		ans.ap[idx++]=og;
		p0=og;
