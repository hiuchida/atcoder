...
//		}
		...
		while (true) {
			...
			int i=rand.nextInt(ans.length());
			String ans2=resolve(ans, i);
			int score2=check(ans2);
			if (score<=score2 || rand.nextFloat()<=Math.exp((score2-score)/current_temperature)) {
				score=score2;
				ans=ans2;
			}
			iteration++;
...
//                System.err.println("iteration: "+iteration+", score: "+score+" i="+i+" "+ans);
            }
        ...
        System.err.println("total distance: "+score);
		System.out.println(ans);
	}
	static String resolve(String ans, int i) {
