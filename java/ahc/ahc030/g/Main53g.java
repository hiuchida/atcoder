...
//				}
	...
	// 占いクエリを取得する
	static BitSet getDivinationQuery(Input input, List<OilLayout> pool, Sim sim) {
		int size = pool.size();
...
//				}
				...
				BitSet query_coordinates = getDivinationQuery(input, pool, sim);
