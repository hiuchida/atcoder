...
//			int c=sc.nextInt();
			if (c==1) {
				Integer u=Integer.valueOf(Integer.parseInt(f2[1]));
				Integer v=Integer.valueOf(Integer.parseInt(f2[2]));
//				Integer u=Integer.valueOf(sc.nextInt());
//				Integer v=Integer.valueOf(sc.nextInt());
				if (cnt.size(u)==0) ans--;
				if (cnt.size(v)==0) ans--;
				cnt.add(u, v);
				cnt.add(v, u);
//				System.out.println(cnt);
				...
				Integer v=Integer.valueOf(Integer.parseInt(f2[1]));
//				Integer v=Integer.valueOf(sc.nextInt());
