...
//			int v=(i * 3) % n + 1;
		...
		SegmentTree st = new SegmentTree(n, Integer.MAX_VALUE, Integer.MAX_VALUE);
		for (int i=0; i<n; i++) {
			st.update(i, ary[i]);
		}
	...
	static class SegmentTree { //SegmentTree_min20250428
		int siz;
		int[] ary;
		int def;
		int inf;
...
/*
end of main1Array 14 181
end of main1Segment 61 2
end of main1Array 104 1912
end of main1Segment 635 1
end of main1Array 988 20054
end of main1Segment 6475 1
*/
