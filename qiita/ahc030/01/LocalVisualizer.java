...
public class LocalVisualizer {
                        ...
                        for (int j = 0; j < input.n; j++) {
                            ...
                            for (int[] d : DIJ) {
                                ...
                                if (ni < 0 || ni >= input.n || nj < 0 || nj >= input.n || !inside[ni][nj]) {
                                    ...
                                    int r = D / 2 - 3;
                                    int x1 = cx + (d - d) * r, y1 = cy + (d + d) * r;
                                    int x2 = cx + (d + d) * r, y2 = cy + (d - d) * r;
    ...
    public static void main(String[] args) throws Exception {
        ...
        Input input = Input.parse(new String(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get(args))));
        String outContent = new String(java.nio.file.Files.readAllBytes(java.nio.file.Paths.get(args)));
